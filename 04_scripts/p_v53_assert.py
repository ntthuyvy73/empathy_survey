# -*- coding: utf-8 -*-
"""
p_v53_assert.py — Đối chiếu TỪNG con số trong bai_bao_1_survey_v53.md với so_lieu_v53.json.
...
MD = open(BASE / '05_bai_bao' / 'bai_bao_1_survey_v53.md', encoding='utf-8').read()
...
for h in ('H1_ban_do_phan_tang', 'H2_timeline_nguon_goc', 'H3_matran_tiepcan_nhanh',
          'H4_truc_ly_thuyet', 'H5_tai_su_dung'):
...
vitri = [MD.find(f'hinh/H{i}_') for i in range(1, 6)]
