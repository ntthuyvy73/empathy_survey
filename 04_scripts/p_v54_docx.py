# -*- coding: utf-8 -*-
"""p_v54_docx.py — Chuyển bai_bao_1_survey_v54.md thành .docx (Times New Roman 12, A4).
...
MD = os.path.join(BASE, 'bai_bao_1_survey_v54.md')
DOCX = os.path.join(BASE, 'bai_bao_1_survey_v54.docx')
